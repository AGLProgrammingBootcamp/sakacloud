...
class EvaluationsControllerTest < ActionController::TestCase
  ...
  test "should create evaluation" do
    assert_difference('Evaluation.count') do
      post :create, evaluation: { comment: @evaluation.comment, sake_id: @evaluation.sake_id, user_id: @evaluation.user_id }
    end
  ...
  test "should update evaluation" do
    patch :update, id: @evaluation, evaluation: { comment: @evaluation.comment, sake_id: @evaluation.sake_id, user_id: @evaluation.user_id }
    assert_redirected_to evaluation_path(assigns(:evaluation))
  end
